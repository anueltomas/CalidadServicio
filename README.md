...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/ReportesCalidadServicio)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/ReportesCalidadServicio)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/ReportesCalidadServicio/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/ReportesCalidadServicio`
* `site/tests/integration/Espo/Modules/ReportesCalidadServicio`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/ReportesCalidadServicio/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/ReportesCalidadServicio/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/reportes-calidad-servicio/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/ReportesCalidadServicio/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/reportes-calidad-servicio/lib/some-lib.js"
    }
}
```
